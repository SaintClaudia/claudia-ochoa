...
story.extend([
    ...
    *section('Professional Experience - Continued', first=True),
    ...
    role(
        ...
        'Led digital brand initiatives that modernized Workday’s online presence during a period of rapid growth spanning its IPO.',
        [
            'Led the redesign of Workday.com ahead of the company’s IPO.',
            'Spearheaded Workday’s first responsive, mobile-first website, modernizing the brand’s digital presence.',
            'Designed the event identity for Workday Rising.',
            'Partnered with internal teams and external agencies to maintain a cohesive brand vision and secure executive approval for high-impact projects.',
            'Mentored junior designers, ensuring high-quality execution and visual consistency.',
        ],
    ),
