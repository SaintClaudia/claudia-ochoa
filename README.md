...
│   ├── lovesac-case-study-5.html     # Lovesac — voice & content strategy (linked from case study 3)
│   ├── lovesac-case-study-4.html     # Lovesac — one-page synopsis of case studies 1, 2, 3 & 5 (linked from case study 5)
